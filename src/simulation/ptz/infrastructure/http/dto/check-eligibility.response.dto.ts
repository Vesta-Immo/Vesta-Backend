...
export class CheckPtzEligibilityResponseDto {
  ...
  @ApiProperty({ example: 100000, description: 'Montant maximum PTZ en euros', required: false })
  maxPtzAmount?: number;

  @ApiProperty({ example: 0, description: 'Taux PTZ en basis points (0 pour PTZ)', required: false })
  ptzRate?: number;

  @ApiProperty({ example: 300, description: 'Durée PTZ en mois', required: false })
  ptzDuration?: number;
